      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <p className="text-purple-200">Sign in to your VGirl account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="rounded border-white/30 bg-white/10 text-pink-500 focus:ring-pink-500 focus:ring-offset-0"
                />
                <span className="ml-2 text-sm text-purple-200">Remember me</span>
              </label>
              <Link href="/auth/forgot-password" className="text-sm text-pink-300 hover:text-pink-200">
                Forgot password?
              </Link>
            </div>
